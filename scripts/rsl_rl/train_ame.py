"""Script to train AME (Attention-Based Map Encoding) agent with RSL-RL."""
...
parser.add_argument("--task", type=str, default="Unitree-G1-29dof-AME", choices=tasks, help="Name of the task.")
...
parser.add_argument(
    "--finetune", action="store_true", default=False, help="Enable finetune mode (Stage 2 training)."
)
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    print(f"[INFO] Using standard OnPolicyRunner with AME encoder.")
