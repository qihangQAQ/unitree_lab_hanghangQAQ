"""AME (Attention-Based Map Encoding) Actor-Critic Network.

This module implements the terrain encoder with multi-head attention
for learning generalized legged locomotion.
"""
