...
# FDM-MPPI demo task: mesh terrain, single env, all config in __post_init__
gym.register(
    id="Unitree-G1-29dof-FDM-Demo",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.fdm_demo_env_cfg:FDM_Demo_EnvCfg",
        "play_env_cfg_entry_point": f"{__name__}.fdm_demo_env_cfg:FDM_Demo_EnvCfg",
        "rsl_rl_cfg_entry_point": f"unitree_rl_lab.tasks.locomotion.agents.rsl_rl_perception_cfg:UnitreePerceptionRunnerCfg",
    },
)
